...
def LiveIRNet_V(input_shape, input_tensor, output_size):
    # Stage 1 #
    ...
    x = Softmax()(x)
    model = Model([img_input], x, name='LiveIRNet_V3S_model')

    return model


def LiveIRNet_V0(input_shape, input_tensor, output_size):
    model = LiveIRNet_V(input_shape, input_tensor, output_size)
    return model